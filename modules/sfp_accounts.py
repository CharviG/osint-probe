...
class sfp_accounts(SpiderFootPlugin):
    ...
    def setup(self, sfc, userOpts=dict()):
        ...
        if content is None:
            ...
            data = self.sf.fetchUrl(url, useragent="SpiderFoot", isJson=True)
    ...
    def checkSite(self, name, site):
        ...
        retname = "name:{},category:{},url:{}".format(site['name'], site['category'], url)
    ...
    def handleEvent(self, event):
        ...
        distrustedChecked = self.sf.cacheGet('sfaccounts_distrustedChecked', 48)
        if not distrustedChecked:
            ...
            self.sf.cachePut('sfaccounts_distrustedChecked', True)
